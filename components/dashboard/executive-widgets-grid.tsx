...
/**
 * Cuatro KPIs ejecutivos: mismo orden e iconografía en Dashboard, Propiedades y Alquileres.
 * Orden: Actualizaciones → Cobros pendientes → Vencimientos → Propiedades y ocupación.
 */
export function ExecutiveWidgetsGrid({ data }: { data: ExecutiveDashboardData }) {
        ...
        <CardContent className="pb-5 pt-0">
          ...
          <div className="mt-3 flex flex-col gap-0.5 border-t border-blue-200/60 pt-2.5 dark:border-blue-800/40">
            ...
            <span className="flex items-center justify-between text-[11px]">
              ...
              <span className="font-semibold tabular-nums text-foreground/80">{disponibles}</span>
            </span>
          </div>
